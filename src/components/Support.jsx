...
const Support = () => (
  <>
    {/* Hero Section */}
    <section className="bg-gradient-to-b from-[#1A97A9] to-[#153c43] text-white py-16 px-4 text-center relative">
      <div className="max-w-3xl mx-auto">
        <div className="flex flex-col items-center justify-center mb-6">
          <ShieldCheck className="w-14 h-14 text-white mb-2 drop-shadow-lg" />
